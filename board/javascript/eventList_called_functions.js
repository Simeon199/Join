...
export async function moveTo(container) { 
  ...
  let task = mainBoard.tasks.find((task) => task.id == elementDraggedOver); // Hier: Diese Funktionalität in die board.js auslagern, denn mainBoard.tasks kann als Import nicht manipuliert werden.
  if (task) {
