...
<div id="big-task-pop-up" class="big-task-pop-up">
    ...
    <div id="big-task-pop-up-priority-container" class="big-task-pop-up-info-container big-edit-task-pop-up-section-container">
        ...
        <div id='big-edit-task-priority-container'>
            <div class='big-edit-task-priority-item' id='big-edit-task-urgent-priority'>
                Urgent
            ...
            <div class='big-edit-task-priority-item' id='big-edit-task-medium-priority'>
                Medium
            ...
            <div class='big-edit-task-priority-item' id='big-edit-task-low-priority'>
                Low
                <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div id="big-task-pop-up-subtask-all">
        ...
        <div id='big-edit-task-subtask-input-container'>
    ...
    <div id="big-task-pop-up-bottom-buttons-container">
        <button id='big-edit-task-pop-up-save-button'>
            Ok
