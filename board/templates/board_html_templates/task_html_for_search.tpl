<template>
<div class="task" id="task${index}" draggable="true" ondragstart="startDragging(id); rotateFunction(taskIndex)" ondragend="checkIfEmpty(category, oppositeCategory)" ondragover="allowDrop(event)" ondrop="moveTo(category)" onclick="showBigTaskPopUp(jsonTextElement)">
