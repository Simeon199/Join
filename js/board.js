...
function changeSubtaskInputIcons() {
  ...
  if (subtaskInputValue.value === "") {
    ...
    <svg id='big-edit-task-subtask-input-save-icon' onclick='changeSaveIconClickedOnStatus()' width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function buildSubtaskArrayForUpload(subtaskArray) {
  let subtaskInput = document.getElementById("big-edit-task-subtask-input");
  subtaskArray.push(subtaskInput.value);
  renderSubtaskInput(subtaskInput.value);
