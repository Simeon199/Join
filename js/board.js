...
function checkBigEditTaskContact(i, contactObject, taskIndex) {
  ...
  // console.log(tasks[taskIndex].assigned);
...
function renderSubtaskInPopUpContainer(i, subtask) {
  // console.log(subtask);
  return /*html*/ `
    <div ondblclick="editSubtask(${i})" id="subtaskNumber${i}" class="edit-popup-subtasks" onmouseover="sowSubaskEdditButtons(${i})" onmouseout="hideSubaskEdditButtons(${i})">
      <li >${subtask["task-description"]}</li>
